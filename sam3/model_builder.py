...
def build_tracker(
    ...
    compile_mode=None,
    use_static_memory: bool = False,
    static_memory_bank_path: Optional[str] = None,
    static_memory_topk: int = 4,
    static_memory_text_weight: float = 1.0,
    static_memory_fusion_alpha: float = 0.15,
    enable_text_encoder: bool = False,
    ...
    if with_backbone:
        ...
        backbone = SAM3VLBackbone(scalp=1, visual=vision_backbone, text=text_encoder)
    ...
    model = Sam3TrackerPredictor(
        ...
        use_static_memory=use_static_memory,
        static_memory_bank_path=static_memory_bank_path,
...
def download_ckpt_from_hf():
    try:
        ...
        raise ImportError(
            "huggingface_hub is required only when downloading checkpoints from Hugging Face. "
            "If you already have a local checkpoint, pass checkpoint_path and set load_from_HF=False."
        ) from exc
